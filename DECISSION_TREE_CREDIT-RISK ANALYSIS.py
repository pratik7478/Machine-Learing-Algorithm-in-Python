...
Decmodel.fit( cr_x_train, cr_y_train)


#BUILDING THE MODLE ONLY X_TEST
#PREDICTION
pred_value=Decmodel.predict(cr_x_test)
pred_value
...
cr.shape()
#----------------------------------------------
a=Decmodel.feature_importances_
a
list(a)
...
f_score=pd.DataFrame({"Importance":Decmodel.feature_importances_,"Variable_Name":cr_x_train.columns})
