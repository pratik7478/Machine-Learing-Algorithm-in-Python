# -*- coding: utf-8 -*-
"""
Created on Sun Mar  8 13:19:14 2020
...
"""
#DISADVANTAGE OF THE NAIVE BAYES

IT TAKE ONLY ONE INDEPENDENT VARIABLE AT A TIME AND
THAT INDEPENDENT VARIABLE MUST BE DEPENDENT ON THE SOME OTHER VARIABLE

where it vl work good?

the presence of the some condtion which increase the conditionql probability
eg:-spam email
""" 
...
NBmodel.fit( cr_x_train, cr_y_train)


#BUILDING THE MODLE ONLY X_TEST
#PREDICTION
pred_value=NBmodel.predict(cr_x_test)
pred_value
